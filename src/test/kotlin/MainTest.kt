...
class MainTest {
    ...
    fun testAllUseCases() {
        ...
        transaction {
            SchemaUtils.create(userCharacterTable)
        }
        transaction {
            SchemaUtils.create(taskTable)
        }
        transaction {
            SchemaUtils.create(buffTable)
        }
        transaction {
            SchemaUtils.create(characterItemTable)
        }
        transaction {
            SchemaUtils.create(characterAbilityTable)
        }
        transaction {
        ...
        transaction {
            SchemaUtils.create(abilityTable)
        }
        transaction {
        ...
        transaction {
            SchemaUtils.drop(userCharacterTable)
        }
        transaction {
            SchemaUtils.drop(userTable)
        }
        transaction {
            SchemaUtils.drop(characterItemTable)
        }
        transaction {
            SchemaUtils.drop(taskTable)
        }
        transaction {
            SchemaUtils.drop(characterAbilityTable)
        }
        transaction {
            SchemaUtils.drop(buffTable)
        }
        transaction {
            SchemaUtils.drop(itemTable)
        }
        transaction {
            SchemaUtils.drop(abilityTable)
        }
        transaction {
            SchemaUtils.drop(challenges)
        }
        transaction {
